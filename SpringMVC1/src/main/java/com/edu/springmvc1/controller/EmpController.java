...
//어노테이션은 jdk5 부터 지원되는 주석 중의 하나로, 우리가 알고 있는 일반적인 주석과는
//달리, 프로그램에서 사용되는 주석
@Controller
@Setter
public class EmpController{
	...
	//상위 자료형을 보유해야, 즉 DI 를 구현해야 유지보수성이 높아짐..결합도 낮아짐..
	...
	//ListController, DetailController...등등 따로 만들필요 없다.

	//이 메서드가 어떤  uri 를 처리할지 uri 매핑
	@RequestMapping("/emps")
